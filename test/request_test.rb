...
class RequestTest < Minitest::Test
  ...
  describe "Authrequest" do
    ...
    it "create the deflated SAMLRequest URL parameter" do
      auth_url = OneLogin::RubySamlF::Authrequest.new.create(settings)
    ...
    it "accept extra parameters" do
      auth_url = OneLogin::RubySamlF::Authrequest.new.create(settings, { :hello => "there" })
      assert_match /&hello=there$/, auth_url

      auth_url = OneLogin::RubySamlF::Authrequest.new.create(settings, { :hello => nil })
    ...
    it "create the saml:AuthnContextClassRef element correctly" do
      ...
      auth_doc = OneLogin::RubySamlF::Authrequest.new.create_authentication_xml_doc(settings)
    ...
    describe "#create_params when the settings indicate to sign (embebed) the request" do
      ...
      it "create a signed request" do
        params = OneLogin::RubySamlF::Authrequest.new.create_params(settings)
    ...
    describe "#create_params when the settings indicate to sign the request" do
      ...
      it "create a signature parameter with RSA_SHA1 and validate it" do
        ...
        params = OneLogin::RubySamlF::Authrequest.new.create_params(settings, :RelayState => 'http://example.com')
