...
class RubySamlFTest < Minitest::Test
  ...
  describe "Logoutresponse" do
    ...
    let(:valid_logout_response_without_settings) { OneLogin::RubySamlF::Logoutresponse.new(valid_logout_response_document) }
    let(:valid_logout_response) { OneLogin::RubySamlF::Logoutresponse.new(valid_logout_response_document, settings) }

    describe "#new" do
      it "raise an exception when response is initialized with nil" do
        assert_raises(ArgumentError) { OneLogin::RubySamlF::Logoutresponse.new(nil) }
      end
      ...
      it "accept constructor-injected options" do
        logoutresponse = OneLogin::RubySamlF::Logoutresponse.new(valid_logout_response_document, nil, { :foo => :bar} )
        assert !logoutresponse.options.empty?
      end
      it "support base64 encoded responses" do
        generated_logout_response = valid_logout_response_document
        logoutresponse = OneLogin::RubySamlF::Logoutresponse.new(Base64.encode64(generated_logout_response), settings)
    ...
    describe "#validate_structure" do
        it "invalidates when the logout response has an invalid xml" do
          settings.soft = true
          logoutresponse = OneLogin::RubySamlF::Logoutresponse.new(invalid_xml_logout_response_document, settings)
    ...
    describe "#validate" do
      describe "when soft=true" do
        ...
        it "validate the logout response" do
          ...
          logoutresponse = OneLogin::RubySamlF::Logoutresponse.new(valid_logout_response_document({:uuid => in_relation_to_request_id}), settings, opts)
        ...
        it "invalidate logout response when initiated with blank" do
          logoutresponse = OneLogin::RubySamlF::Logoutresponse.new("", settings)
          assert !logoutresponse.validate
        ...
        it "invalidate logout response when initiated with no idp cert or fingerprint" do
          ...
          logoutresponse = OneLogin::RubySamlF::Logoutresponse.new(valid_logout_response_document, settings)
          assert !logoutresponse.validate
        ...
        it "invalidate logout response with wrong id when given option :matches_request_id" do
          ...
          logoutresponse = OneLogin::RubySamlF::Logoutresponse.new(valid_logout_response_document, settings, opts)
        ...
        it "invalidate logout response with wrong request status" do
          logoutresponse = OneLogin::RubySamlF::Logoutresponse.new(unsuccessful_logout_response_document, settings)
        ...
        it "invalidate logout response when in lack of issuer setting" do
          ...
          logoutresponse = OneLogin::RubySamlF::Logoutresponse.new(unsuccessful_logout_response_document, bad_settings)
          assert !logoutresponse.validate
        ...
        it "invalidate logout response with wrong issuer" do
          ...
          logoutresponse = OneLogin::RubySamlF::Logoutresponse.new(valid_logout_response_document({:uuid => in_relation_to_request_id}), settings)
          assert !logoutresponse.validate
      ...
      describe "when soft=false" do
        ...
        it "raises validation error when response initiated with blank" do
          ...
          assert_raises(OneLogin::RubySamlF::ValidationError) { logoutresponse.validate }
          assert_includes logoutresponse.errors, "Blank logout response"
        end
      ...
      describe "#validate_signature" do
        let (:params) { OneLogin::RubySamlF::SloLogoutresponse.new.create_params(settings, random_id, "Custom Logout Message", :RelayState => 'http://example.com') }
        ...
        it "return true when valid RSA_SHA1 Signature" do
          ...
          logoutresponse_sign_test = OneLogin::RubySamlF::Logoutresponse.new(params['SAMLResponse'], settings, options)
        ...
        it "return true when valid RSA_SHA256 Signature" do
          ...
          options = {}
          options[:get_params] = params
          logoutresponse = OneLogin::RubySamlF::Logoutresponse.new(params['SAMLResponse'], settings, options)
        ...
        it "raise when invalid RSA_SHA1 Signature" do
          ...
          assert_raises(OneLogin::RubySamlF::ValidationError) { logoutresponse.send(:validate_signature) }
