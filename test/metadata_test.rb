...
class MetadataTest < Minitest::Test
  ...
  describe 'Metadata' do
    ...
    let(:xml_text)          { OneLogin::RubySamlF::Metadata.new.generate(settings, false) }
    ...
    it "generates Pretty Print Service Provider Metadata" do
      xml_text = OneLogin::RubySamlF::Metadata.new.generate(settings, true)
    ...
    it "generates Service Provider Metadata" do
      ...
      xml_metadata = OneLogin::RubySamlF::Metadata.new.generate(settings, false)
