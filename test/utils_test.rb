...
class UtilsTest < Minitest::Test
  describe ".format_cert" do
    ...
    it "returns empty string when the cert is an empty string" do
      cert = ""
      assert_equal "", OneLogin::RubySamlF::Utils.format_cert(cert)
    end

    it "returns nil when the cert is nil" do
      cert = nil
      assert_equal nil, OneLogin::RubySamlF::Utils.format_cert(cert)
    end

    it "returns the certificate when it is valid" do
      assert_equal formatted_certificate, OneLogin::RubySamlF::Utils.format_cert(formatted_certificate)
    end
    ...
    it "reformats the certificate when there are spaces and no line breaks" do
      ...
      assert_equal formatted_certificate, OneLogin::RubySamlF::Utils.format_cert(invalid_certificate1)
    end
    ...
    it "reformats the certificate when there are spaces and no headers" do
      ...
      assert_equal formatted_certificate, OneLogin::RubySamlF::Utils.format_cert(invalid_certificate2)
    end
    ...
    it "reformats the certificate when there line breaks and no headers" do
      ...
      assert_equal formatted_certificate, OneLogin::RubySamlF::Utils.format_cert(invalid_certificate3)
    end
  end
  ...
  describe ".format_private_key" do
    ...
    it "returns empty string when the private key is an empty string" do
      private_key = ""
      assert_equal "", OneLogin::RubySamlF::Utils.format_private_key(private_key)
    end

    it "returns nil when the private key is nil" do
      private_key = nil
      assert_equal nil, OneLogin::RubySamlF::Utils.format_private_key(private_key)
    end

    it "returns the private key when it is valid" do
      assert_equal formatted_private_key, OneLogin::RubySamlF::Utils.format_private_key(formatted_private_key)
    end
    ...
    it "reformats the private key when there are spaces and no line breaks" do
      ...
      assert_equal formatted_private_key, OneLogin::RubySamlF::Utils.format_private_key(invalid_private_key1)
    end
    ...
    it "reformats the private key when there are spaces and no headers" do
      ...
      assert_equal formatted_private_key, OneLogin::RubySamlF::Utils.format_private_key(invalid_private_key2)
    end
    ...
    it "reformats the private key when there line breaks and no headers" do
      ...
      assert_equal formatted_private_key, OneLogin::RubySamlF::Utils.format_private_key(invalid_private_key3)
    end
    ...
    describe "an RSA public key" do
      ...
      it "returns the private key when it is valid" do
        assert_equal formatted_rsa_private_key, OneLogin::RubySamlF::Utils.format_private_key(formatted_rsa_private_key)
      end

      it "reformats the private key when there are spaces and no line breaks" do
        invalid_rsa_private_key1 = read_certificate("invalid_rsa_private_key1")
        assert_equal formatted_rsa_private_key, OneLogin::RubySamlF::Utils.format_private_key(invalid_rsa_private_key1)
      end

      it "reformats the private key when there are spaces and no headers" do
        invalid_rsa_private_key2 = read_certificate("invalid_rsa_private_key2")
        assert_equal formatted_private_key, OneLogin::RubySamlF::Utils.format_private_key(invalid_rsa_private_key2)
      end

      it "reformats the private key when there line breaks and no headers" do
        invalid_rsa_private_key3 = read_certificate("invalid_rsa_private_key3")
        assert_equal formatted_private_key, OneLogin::RubySamlF::Utils.format_private_key(invalid_rsa_private_key3)
      end
    end
  end
  ...
  describe "build_query" do
    it "returns the query string" do
      ...
      query_string = OneLogin::RubySamlF::Utils.build_query(params)
  ...
  describe "#verify_signature" do
    ...
    it "returns true when the signature is valid" do
      ...
      assert OneLogin::RubySamlF::Utils.verify_signature(@params)
    end
  ...
  describe "#status_error_msg" do
    it "returns a error msg with a status message" do
      ...
      status_error_msg = OneLogin::RubySamlF::Utils.status_error_msg(error_msg, status_code, status_message)
      ...
      status_error_msg2 = OneLogin::RubySamlF::Utils.status_error_msg(error_msg, status_code)
      assert_equal = "The status code of the Logout Response was not Success, was Requester", status_error_msg2

      status_error_msg3 =  OneLogin::RubySamlF::Utils.status_error_msg(error_msg)
