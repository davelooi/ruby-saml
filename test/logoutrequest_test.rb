...
class RequestTest < Test::Unit::TestCase
  ...
  context "Logoutrequest" do
    ...
    should "set sessionindex" do
      ...
      unauth_url = OneLogin::RubySamlF::Logoutrequest.new.create(settings, { :name_id => "there" })
      inflated = decode_saml_request_payload(unauth_url)
    ...
    should "require name_identifier_value" do
      ...
      assert_raises(OneLogin::RubySamlF::ValidationError) { OneLogin::RubySamlF::Logoutrequest.new.create(settings) }
    end
