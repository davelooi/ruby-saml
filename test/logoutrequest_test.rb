...
class RequestTest < Minitest::Test
  ...
  describe "Logoutrequest" do
    ...
    it "create the deflated SAMLRequest URL parameter" do
      unauth_url = OneLogin::RubySamlF::Logoutrequest.new.create(settings)
    ...
    it "support additional params" do
      unauth_url = OneLogin::RubySamlF::Logoutrequest.new.create(settings, { :hello => nil })
      assert_match /&hello=$/, unauth_url

      unauth_url = OneLogin::RubySamlF::Logoutrequest.new.create(settings, { :foo => "bar" })
    ...
    it "set sessionindex" do
      ...
      unauth_url = OneLogin::RubySamlF::Logoutrequest.new.create(settings, { :nameid => "there" })
      inflated = decode_saml_request_payload(unauth_url)
    ...
    describe "consumation of logout may need to track the transaction" do
      it "have access to the request uuid" do
        ...
        unauth_req = OneLogin::RubySamlF::Logoutrequest.new
    ...
    describe "when the settings indicate to sign (embedded) logout request" do
      ...
      it "create a signed logout request with 256 digest and signature method" do
        ...
        params = OneLogin::RubySamlF::Logoutrequest.new.create_params(settings)
