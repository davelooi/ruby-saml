...
class RubySamlFTest < Minitest::Test
  ...
  describe "Response" do
    ...
    let(:response) { OneLogin::RubySamlF::Response.new(response_document_without_recipient) }
    let(:response_without_attributes) { OneLogin::RubySamlF::Response.new(response_document_without_attributes) }
    let(:response_without_reference_uri) { OneLogin::RubySamlF::Response.new(response_document_without_reference_uri) }
    let(:response_with_signed_assertion) { OneLogin::RubySamlF::Response.new(response_document_with_signed_assertion) }
    let(:response_with_ds_namespace_at_the_root) { OneLogin::RubySamlF::Response.new(response_document_with_ds_namespace_at_the_root)}
    let(:response_unsigned) { OneLogin::RubySamlF::Response.new(response_document_unsigned) }
    let(:response_wrapped) { OneLogin::RubySamlF::Response.new(response_document_wrapped) }
    let(:response_multiple_attr_values) { OneLogin::RubySamlF::Response.new(fixture(:response_with_multiple_attribute_values)) }
    let(:response_valid_signed) { OneLogin::RubySamlF::Response.new(response_document_valid_signed) }
    let(:response_valid_signed_without_x509certificate) { OneLogin::RubySamlF::Response.new(response_document_valid_signed_without_x509certificate) }
    let(:response_no_id) { OneLogin::RubySamlF::Response.new(read_invalid_response("no_id.xml.base64")) }
    let(:response_no_version) { OneLogin::RubySamlF::Response.new(read_invalid_response("no_saml2.xml.base64")) }
    let(:response_multi_assertion) { OneLogin::RubySamlF::Response.new(read_invalid_response("multiple_assertions.xml.base64")) }
    let(:response_no_status) { OneLogin::RubySamlF::Response.new(read_invalid_response("no_status.xml.base64")) }
    let(:response_no_statuscode) { OneLogin::RubySamlF::Response.new(read_invalid_response("no_status_code.xml.base64")) }
    let(:response_statuscode_responder) { OneLogin::RubySamlF::Response.new(read_invalid_response("status_code_responder.xml.base64")) }
    let(:response_statuscode_responder_and_msg) { OneLogin::RubySamlF::Response.new(read_invalid_response("status_code_responer_and_msg.xml.base64")) }
    let(:response_encrypted_attrs) { OneLogin::RubySamlF::Response.new(read_invalid_response("response_encrypted_attrs.xml.base64")) }
    let(:response_no_signed_elements) { OneLogin::RubySamlF::Response.new(read_invalid_response("no_signature.xml.base64")) }
    let(:response_multiple_signed) { OneLogin::RubySamlF::Response.new(read_invalid_response("multiple_signed.xml.base64")) }
    let(:response_invalid_audience) { OneLogin::RubySamlF::Response.new(read_invalid_response("invalid_audience.xml.base64")) }
    let(:response_invalid_signed_element) { OneLogin::RubySamlF::Response.new(read_invalid_response("response_invalid_signed_element.xml.base64")) }
    let(:response_invalid_issuer_assertion) { OneLogin::RubySamlF::Response.new(read_invalid_response("invalid_issuer_assertion.xml.base64")) }
    let(:response_invalid_issuer_message) { OneLogin::RubySamlF::Response.new(read_invalid_response("invalid_issuer_message.xml.base64")) }
    let(:response_no_subjectconfirmation_data) { OneLogin::RubySamlF::Response.new(read_invalid_response("no_subjectconfirmation_data.xml.base64")) }
    let(:response_no_subjectconfirmation_method) { OneLogin::RubySamlF::Response.new(read_invalid_response("no_subjectconfirmation_method.xml.base64")) }
    let(:response_invalid_subjectconfirmation_inresponse) { OneLogin::RubySamlF::Response.new(read_invalid_response("invalid_subjectconfirmation_inresponse.xml.base64")) }
    let(:response_invalid_subjectconfirmation_recipient) { OneLogin::RubySamlF::Response.new(read_invalid_response("invalid_subjectconfirmation_recipient.xml.base64")) }
    let(:response_invalid_subjectconfirmation_nb) { OneLogin::RubySamlF::Response.new(read_invalid_response("invalid_subjectconfirmation_nb.xml.base64")) }
    let(:response_invalid_subjectconfirmation_noa) { OneLogin::RubySamlF::Response.new(read_invalid_response("invalid_subjectconfirmation_noa.xml.base64")) }
    let(:response_invalid_signature_position) { OneLogin::RubySamlF::Response.new(read_invalid_response("invalid_signature_position.xml.base64")) }
    let(:response_encrypted_nameid) { OneLogin::RubySamlF::Response.new(response_document_encrypted_nameid) }

    it "raise an exception when response is initialized with nil" do
      assert_raises(ArgumentError) { OneLogin::RubySamlF::Response.new(nil) }
    end

    it "be able to parse a document which contains ampersands" do
      XMLSecurity::SignedDocument.any_instance.stubs(:digests_match?).returns(true)
      OneLogin::RubySamlF::Response.any_instance.stubs(:validate_conditions).returns(true)

      ampersands_response = OneLogin::RubySamlF::Response.new(ampersands_document)
    ...
    describe "Prevent XEE attack" do
      before do
        @response = OneLogin::RubySamlF::Response.new(fixture(:attackxee))
      end
      ...
      it "raise when evil attack vector is present, soft = false " do
        ...
        assert_raises(OneLogin::RubySamlF::ValidationError) do
    ...
    it "default to raw input when a response is not Base64 encoded" do
      ...
      response_from_raw = OneLogin::RubySamlF::Response.new(decoded)
    ...
    describe "#is_valid?" do
      describe "soft = false" do
        ...
        it "raise when response is initialized with blank data" do
          blank_response = OneLogin::RubySamlF::Response.new('')
          blank_response.soft = false
          error_msg = "Blank response"
          assert_raises(OneLogin::RubySamlF::ValidationError, error_msg) do
        ...
        it "validate SAML 2.0 XML structure" do
          ...
          response_unsigned_mod = OneLogin::RubySamlF::Response.new(Base64.encode64(resp_xml))
          ...
          assert_raises(OneLogin::RubySamlF::ValidationError, 'Digest mismatch') do
        ...
        it "raise when the inResponseTo value does not match the Request ID" do
          ...
          response_valid_signed = OneLogin::RubySamlF::Response.new(response_document_valid_signed, opts)
      ...
      describe "soft = true" do
        ...
        it "support dynamic namespace resolution on signature elements" do
          no_signature_response = OneLogin::RubySamlF::Response.new(fixture("no_signature_ns.xml"))
        ...
        it "validate ADFS assertions" do
          adfs_response = OneLogin::RubySamlF::Response.new(fixture(:adfs_response_sha256))
    ...
    describe "#validate_structure" do
      ...
      it "raise when encountering a mailformed element that prevents the document from being valid" do
        response_without_attributes.soft = false
        assert_raises(OneLogin::RubySamlF::ValidationError) {
          response_without_attributes.send(:validate_structure)
        }
      end
    end
    ...
    describe "#validate_in_response_to" do
      it "return true when the inResponseTo value matches the Request ID" do
        response = OneLogin::RubySamlF::Response.new(response_document_valid_signed, :settings => settings, :matches_request_id => "_fc4a34b0-7efb-012e-caae-782bcb13bb38")
        assert response.send(:validate_in_response_to)
        assert_empty response.errors
      end

      it "return true when no Request ID is provided for checking" do
        response = OneLogin::RubySamlF::Response.new(response_document_valid_signed, :settings => settings)
        assert response.send(:validate_in_response_to)
        assert_empty response.errors
      end

      it "return false when the inResponseTo value does not match the Request ID" do
        response = OneLogin::RubySamlF::Response.new(response_document_valid_signed, :settings => settings, :matches_request_id => "invalid_request_id")
        assert !response.send(:validate_in_response_to)
    ...
    describe "#validate_subject_confirmation" do
      ...
      it "return true when the skip_subject_confirmation option is passed and the subject confirmation is valid" do
        ...
        response_with_skip = OneLogin::RubySamlF::Response.new(response_document_valid_signed, opts)
      ...
      it "return true when the skip_subject_confirmation option is passed and the response has an invalid subject confirmation" do
        opts = {}
        opts[:skip_subject_confirmation] = true
        response_with_skip = OneLogin::RubySamlF::Response.new(read_invalid_response("invalid_subjectconfirmation_noa.xml.base64"), opts)
        response_with_skip.settings = settings
        Time.expects(:now).times(0) # ensures the test isn't run and thus Time.now.utc is never called within the test
        assert response_with_skip.send(:validate_subject_confirmation)
        assert_empty response_with_skip.errors
    ...
    describe "#validate_session_expiration" do
      ...
      it "returns true when the session has expired, but is still within the allowed_clock_drift" do
        ...
        response_with_drift = OneLogin::RubySamlF::Response.new(response_document_without_recipient, opts)
    ...
    describe "#nameid" do
      ...
      it "be extractable from an OpenSAML response" do
        response_open_saml = OneLogin::RubySamlF::Response.new(fixture(:open_saml))
        assert_equal "someone@example.org", response_open_saml.nameid
      end

      it "be extractable from a Simple SAML PHP response" do
        response_ssp = OneLogin::RubySamlF::Response.new(fixture(:simple_saml_php))
    ...
    describe "#sessionindex" do
      it "extract the value of the sessionindex element" do
        response = OneLogin::RubySamlF::Response.new(fixture(:simple_saml_php))
    ...
    describe "#check_conditions" do
      it "check time conditions" do
        ...
        response_time_updated = OneLogin::RubySamlF::Response.new(response_document_without_recipient_with_time_updated)
        ...
        Timecop.freeze(Time.parse("2011-06-14T18:25:01.516Z")) do
          response_with_saml2_namespace = OneLogin::RubySamlF::Response.new(response_document_with_saml2_namespace)
      ...
      it "optionally allows for clock drift" do
        ...
        Timecop.freeze(Time.parse("2011-06-14T18:21:01Z")) do
          settings.soft = true
          special_response_with_saml2_namespace = OneLogin::RubySamlF::Response.new(
    ...
    describe "#attributes" do
      ...
      it "not raise errors about nil/empty attributes for EncryptedAttributes" do
        response_no_cert_and_encrypted_attrs = OneLogin::RubySamlF::Response.new(response_document_no_cert_and_encrypted_attrs)
        assert_equal 'Demo', response_no_cert_and_encrypted_attrs.attributes["first_name"]
      end

      it "not raise on responses without attributes" do
        assert_equal OneLogin::RubySamlF::Attributes.new, response_unsigned.attributes
      end
      ...
      describe "#multiple values" do
        ...
        it "extract single value as string in compatibility mode off" do
          OneLogin::RubySamlF::Attributes.single_value_compatibility = false
          assert_equal ["demo"], response_multiple_attr_values.attributes[:uid]
          # classes are not reloaded between tests so restore default
          OneLogin::RubySamlF::Attributes.single_value_compatibility = true
        end
        ...
        it "return multiple values including nil and empty string" do
          response = OneLogin::RubySamlF::Response.new(fixture(:response_with_multiple_attribute_values))
    ...
    describe '#xpath_first_from_signed_assertion' do
      it 'not allow arbitrary code execution' do
        ...
        malicious_response = OneLogin::RubySamlF::Response.new(malicious_response_document)
    ...
    describe '#sign_document' do
      it 'Sign an unsigned SAML Response XML and initiate the SAML object with it' do
        ...
        formated_cert = OneLogin::RubySamlF::Utils.format_cert(ruby_saml_cert_text)
        cert = OpenSSL::X509::Certificate.new(formated_cert)

        formated_private_key = OneLogin::RubySamlF::Utils.format_private_key(ruby_saml_key_text)
        private_key = OpenSSL::PKey::RSA.new(formated_private_key)
        document.sign_document(private_key, cert)

        signed_response = OneLogin::RubySamlF::Response.new(document.to_s)
        settings.idp_cert = ruby_saml_cert_text
    ...
    describe "retrieve nameID" do
      ...
      it 'is not possible when encryptID inside the assertion but no private key' do
          ...
          assert_raises(OneLogin::RubySamlF::ValidationError, "An EncryptedID found and no SP private key found on the settings to decrypt it") do
  ...
  describe 'try to initialize an encrypted response' do
    it 'raise if an encrypted assertion is found and no sp private key to decrypt it' do
      ...
      assert_raises(OneLogin::RubySamlF::ValidationError, error_msg) do
        response = OneLogin::RubySamlF::Response.new(signed_message_encrypted_unsigned_assertion)
      end

      assert_raises(OneLogin::RubySamlF::ValidationError, error_msg) do
        response2 = OneLogin::RubySamlF::Response.new(signed_message_encrypted_unsigned_assertion, :settings => settings)
      end

      settings.certificate = ruby_saml_cert_text
      settings.private_key = ruby_saml_key_text
      assert_raises(OneLogin::RubySamlF::ValidationError, error_msg) do
        response3 = OneLogin::RubySamlF::Response.new(signed_message_encrypted_unsigned_assertion)
        response3.settings
      end
    end
    ...
    it 'raise if an encrypted assertion is found and the sp private key is wrong' do
      ...
      assert_raises(OpenSSL::PKey::RSAError, error_msg) do
        response = OneLogin::RubySamlF::Response.new(signed_message_encrypted_unsigned_assertion, :settings => settings)
      end
   end
    ...
    it 'return true if an encrypted assertion is found and settings initialized with private_key' do
      ...
      response2 = OneLogin::RubySamlF::Response.new(signed_message_encrypted_signed_assertion, :settings => settings)
      assert response2.decrypted_document

      response3 = OneLogin::RubySamlF::Response.new(unsigned_message_encrypted_signed_assertion, :settings => settings)
      assert response3.decrypted_document

      response4 = OneLogin::RubySamlF::Response.new(unsigned_message_encrypted_unsigned_assertion, :settings => settings)
  ...
  describe "retrieve nameID and attributes from encrypted assertion" do
    ...
    it 'is possible when signed_message_encrypted_signed_assertion' do
      response = OneLogin::RubySamlF::Response.new(signed_message_encrypted_signed_assertion, :settings => settings)
      Timecop.freeze(Time.parse("2015-03-19T14:30:31Z")) do
        assert response.is_valid?
        assert_empty response.errors
        assert_equal "test", response.attributes[:uid]
    ...
    it 'is possible when unsigned_message_encrypted_signed_assertion' do
      response = OneLogin::RubySamlF::Response.new(unsigned_message_encrypted_signed_assertion, :settings => settings)
      Timecop.freeze(Time.parse("2015-03-19T14:30:31Z")) do
        assert response.is_valid?
        assert_empty response.errors
        assert_equal "test", response.attributes[:uid]
    ...
    it 'is not possible when unsigned_message_encrypted_unsigned_assertion' do
      response = OneLogin::RubySamlF::Response.new(unsigned_message_encrypted_unsigned_assertion, :settings => settings)
      Timecop.freeze(Time.parse("2015-03-19T14:30:31Z")) do
        assert !response.is_valid?
  ...
  describe "#decrypt_assertion" do
    ...
    describe "check right settings" do
      ...
      it "is possible to decrypt the assertion if private key but no saml namespace on the Assertion Element that is inside the EncryptedAssertion" do
        ...
        response = OneLogin::RubySamlF::Response.new(unsigned_message_encrypted_assertion_without_saml_namespace, :settings => settings)
        encrypted_assertion_node = REXML::XPath.first(
          response.document,
          "(/p:Response/EncryptedAssertion/)|(/p:Response/a:EncryptedAssertion/)",
          { "p" => "urn:oasis:names:tc:SAML:2.0:protocol", "a" => "urn:oasis:names:tc:SAML:2.0:assertion" }
    ...
    describe "check different encrypt methods supported" do
      it "EncryptionMethod DES-192 && Key Encryption Algorithm RSA-1_5" do
        ...
        response = OneLogin::RubySamlF::Response.new(unsigned_message_des192_encrypted_signed_assertion, :settings => settings)
        assert_equal "test", response.attributes[:uid]
      ...
      it "EncryptionMethod AES-128 && Key Encryption Algorithm RSA-OAEP-MGF1P" do
        ...
        response = OneLogin::RubySamlF::Response.new(unsigned_message_aes128_encrypted_signed_assertion, :settings => settings)
        assert_equal "test", response.attributes[:uid]
        assert_equal "_ce3d2948b4cf20146dee0a0b3dd6f69b6cf86f62d7", response.nameid
      end
      ...
      it "EncryptionMethod AES-192 && Key Encryption Algorithm RSA-OAEP-MGF1P" do
        ...
        response = OneLogin::RubySamlF::Response.new(unsigned_message_aes192_encrypted_signed_assertion, :settings => settings)
        assert_equal "test", response.attributes[:uid]
        assert_equal "_ce3d2948b4cf20146dee0a0b3dd6f69b6cf86f62d7", response.nameid
      end
      ...
      it "EncryptionMethod AES-256 && Key Encryption Algorithm RSA-OAEP-MGF1P" do
        ...
        response = OneLogin::RubySamlF::Response.new(unsigned_message_aes256_encrypted_signed_assertion, :settings => settings)
        assert_equal "test", response.attributes[:uid]
        assert_equal "_ce3d2948b4cf20146dee0a0b3dd6f69b6cf86f62d7", response.nameid
      end
    end
  ...
  describe "test qualified name id in attributes" do
    ...
    it "parsed the nameid" do
     response = OneLogin::RubySamlF::Response.new(read_response("signed_nameid_in_atts.xml"), :settings => settings)
  ...
  describe "test unqualified name id in attributes" do
    ...
    it "parsed the nameid" do
     response = OneLogin::RubySamlF::Response.new(read_response("signed_unqual_nameid_in_atts.xml"), :settings => settings)
     response.settings.idp_cert_fingerprint = 'c51985d947f1be57082025050846eb27f6cab783'
     assert_empty response.errors
     assert_equal "test", response.attributes[:uid]
