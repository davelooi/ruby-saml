  ...
  module RubySamlF
    ...
    class Settings
      ...
      def get_idp_cert
        ...
        formated_cert = OneLogin::RubySamlF::Utils.format_cert(idp_cert)
      ...
      def get_sp_cert
        ...
        formated_cert = OneLogin::RubySamlF::Utils.format_cert(certificate)
        OpenSSL::X509::Certificate.new(formated_cert)
      end
      ...
      def get_sp_key
        ...
        formated_private_key = OneLogin::RubySamlF::Utils.format_private_key(private_key)
