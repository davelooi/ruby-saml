    ...
    def validate_document(idp_cert_fingerprint, soft = true, options = {})
      ...
      if cert_element        
        ...
        if fingerprint != idp_cert_fingerprint.gsub(/[^a-zA-Z0-9]/,"").downcase
          ...
          return soft ? false : (raise OneLogin::RubySamlF::ValidationError.new("Fingerprint mismatch"))
        end
      else
        if options[:cert]
          ...
          if soft
            ...
            raise OneLogin::RubySamlF::ValidationError.new("Certificate element missing in response (ds:X509Certificate) and not cert provided at settings")
          end          
        end
      end
    ...
    def validate_signature(base64_cert, soft = true)
      ...
      REXML::XPath.each(sig_element, "//ds:Reference", {"ds"=>DSIG}) do |ref|
        ...
        unless digests_match?(hash, digest_value)
          ...
          return soft ? false : (raise OneLogin::RubySamlF::ValidationError.new("Digest mismatch"))
        end
      end
      ...
      unless cert.public_key.verify(signature_algorithm.new, signature, canon_string)
        ...
        return soft ? false : (raise OneLogin::RubySamlF::ValidationError.new("Key validation error"))
      end
